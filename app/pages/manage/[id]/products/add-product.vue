...
definePageMeta({ name: 'add-product', layout: 'details', auth: false });
    ...
    <div class="container-sm no-edge">
      ...
      >
        <div class="field">
          ...
          <input
            v-model.number="newProduct.tab2.price"
            id="prod-price"
            class="form-item"
            type="number"
          ...
          <div class="flexbox align-center guttered">
            ...
            >
              <div class="drop menu">
                <div
                  class="item"
                  v-for="(template, templateName) in specificationTemplates"
                  @click="
                    newProduct.tab3.specifications = specificationTemplates[
                      templateName
                    ].map((spec) => ({ name: spec, value: '' }))
                  "
                >
                  {{ templateName }}
                </div>
              ...
              <tr v-for="(spec, index) in newProduct.tab3.specifications">
                ...
                <td class="text-center">
                  <button
                    ...
                    v-tooltip.unblocking="'Remove specification'"
