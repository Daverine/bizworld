...
<template>
    ...
    <div v-if="$route.path === '/register'" class="flexbox equal-cols" style="gap: 1.5rem; max-width: 650px; margin: 2rem auto;">
    ...
    <div v-else class="flexbox equal-cols" style="gap: 1.5rem; max-width: 650px; margin: 2rem auto;">
        <div class="col" style="background-image: linear-gradient(rgb(48 187 48), rgb(10 81 194));"></div>
        <div class="col">
            <div class="header" style="margin-bottom: 1rem;">
                <div class="bold">
