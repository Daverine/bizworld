...
<template>
  <div v-if="details" class="dialog self-scroll full-screen sc-dialog" :data-type="details.type">
    <div class="header dm-header a-block flexbox" :class="{ active: activeFixedMenu }">
      ...
      <div style="padding: 1em 1.5em;">
        <div class="dm-gap">
          <div class="dm-logo" :style="`background-image: url('${details.logo}')`">
            <SvgIcon v-if="details.verified" name="verified_sp" v-tooltip.unblocking data-tooltip="Verified"
              class="green-text" style="position: absolute; bottom: -3px; right: -5px;" />
          </div>
        ...
        <div class="dm-gap">
          ...
          <div>
            ...
            <SvgIcon name="info" class="mini l-spaced" style="color: var(--on-surface-variant);" v-tooltip.unblocking
          ...
          <table class="dm-info table borderless">
            <tbody>
              <tr>
                ...
                <td>{{ details.description }} <a :href="`${details.bizUrl}/about_us`" target="_blank">Learn
                    more.</a>
                </td>
              </tr>
              <tr>
                ...
                <td>{{ `${details.location.address}, ${details.location.city}, ${details.location.state}.`
                  }}</td>
              </tr>
              <tr>
                <td>
              ...
              <table class="table compact borderless 0-margined">
                <tbody>
                  <tr v-for="i in 5" :set="(n = 6 - i)">
                    ...
                    <td style="width: 15px; text-align: right;">{{ `(${details.reviews.filter((elem) =>
                      elem.rating
                      ===
                      n).length})` }}</td>
                  </tr>
        ...
        <div>
          ...
          <div class="dm-reviews">
            <div v-for="a in Math.min(5, details.reviews.length)" class="dm-review"
              ...
              <header>
                <div class="avatar image"><span class="huge uppercased">{{ review.username.split('')[0] }}</span>
                </div>
                <div class="content">
